...
class SerachedVideoListWidget extends StatefulWidget {
  List<dynamic> videoList;
  SerachedVideoListWidget(this.videoList);

  @override
  _SerachedVideoListWidgetState createState() =>
      _SerachedVideoListWidgetState();
}

class _SerachedVideoListWidgetState extends State<SerachedVideoListWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:
          // StreamBuilder(
          //   stream: widget.videoList,
          //   builder: (contex, AsyncSnapshot streamSnapShot) {
          //     // getThumbnails(streamSnapShot.data);
          //     if (streamSnapShot.connectionState == ConnectionState.waiting) {
          //       return Center(child: CircularProgressIndicator());
          //     }
          //     print("stremShot--------------${streamSnapShot.data}");
          //     return
          ListView.builder(
        ...
        itemBuilder: (ctx, index) {
          return FutureBuilder(
            future: getThumbnails(widget.videoList[index]['videoPath']),
            builder: (_, snapshot) {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context)
                          ...
                          widget.videoList[index]['videoPath'],
                          widget.videoList[index]['topic'],
